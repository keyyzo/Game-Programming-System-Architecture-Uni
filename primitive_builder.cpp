...
void PrimitiveBuilder::Init()
{
	...
	// added extra colours for use in game
	orange_material_.set_colour(0xff3467eb);
	yellow_material_.set_colour(0xff00ffff);
	purple_material_.set_colour(0xfff20f80);
	gray_material_.set_colour(0xff636363);
	grass_green_material_.set_colour(0xff0a631a);
	brown_material_.set_colour(0xff04465e);
	light_blue_material_.set_colour(0xffe3dc0e);
	light_pink_material_.set_colour(0xffde87d1);
}
